...
// 은행계좌 + 직불카드 + 교통카드
public class CheckingTrafficCardAccount {

    private static Object CradNo;
    // 교통카드 기능 여부(true 인 경우만 교통카드 기능 탑재)
    private boolean hasTrafficCard;

    public CheckingTrafficCardAccount(String accountNo, String owner, int balance, String cardNo, Object CardNo) {
    ...
    public CheckingTrafficCardAccount(String accountNo, String owner, int balance, String cardNo,
        ...
        super(accountNo, owner, balance, CradNo);
