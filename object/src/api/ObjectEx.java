...
public class ObjectEx {
    public static void main(String[] args) {
        ...
        // ~ 투스트링 -> 오버라이딩 : 하는이유? 부모가 내려줄때 주소로 출력 됨
        // ~ 실제로 코딩을 했을때 주소가 필요하지 않음, 객체멤버 값 필요 -> 그래서 오버라이딩!
        ...
        // ~ 내가 정의한거 아니면 다 부모꺼다, toString 그냥 주소출력 하는걸로 넘겨 줌, '오버라이딩' 해야한다 equals 를,
        // ~ 이거 하면 ㅇ -> ㅁ 로 바뀐다
        // ~ value 의 부모는 object 다. 밸류타입으로 바꿔줘야 한다. 10 으로 값이 같으면 true, 다르면 false 로 도출해
